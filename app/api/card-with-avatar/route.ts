...
export async function GET(request: NextRequest) {
  try {
    ...
    const svg = generateCardWithEmbeddedAvatar(data, theme, avatarBase64, backgroundBase64, backgroundMime)
...
function generateCardWithEmbeddedAvatar(data: any, theme: any, avatarBase64: string, backgroundBase64: string, backgroundMime = "image/jpeg"): string {
